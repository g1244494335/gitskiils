        ...
        <FootWrapper>
            <div className="content w980">
                ...
                <FootRight>
                    <ul>
                        <li className="unit">
                            <a className="foot-enter-new logo-amped" href="#"></a>
                            <span className="foot-enter-tt tt-amped"></span>
                        </li>
                        <li className="unit">
                            <a className="foot-enter-new logo-auth" href="#"></a>
                            <span className="foot-enter-tt auth"></span>
                        </li>
                        <li className="unit">
                            <a className="foot-enter-new logo-musician" href="#"></a>
                            <span className="foot-enter-tt musician"></span>
                        </li>
                        <li className="unit">
                            <a className="foot-enter-new logo-reward" href="#"></a>
                            <span className="foot-enter-tt reward"></span>
                        </li>
                        <li className="unit">
                            <a className="foot-enter-new logo-cash" href="#"></a>
                            <span className="foot-enter-tt cash"></span>
                        </li>
                    </ul>
                </FootRight>
            </div>
