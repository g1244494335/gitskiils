    ...
    return (
        <FootWrapper>
            <div className="content w980">
                ...
                <FootRight>
                    <div className="unit">
                        <a className="foot-enter-new logo-amped" href="https://web-amped.music.163.com/"  "></a>
                        <span className="foot-enter-tt tt-amped"></span>
                    </div>
                    <div className="unit">
                        <a className="foot-enter-new logo-auth" href="//music.163.com/st/userbasic#/auth"  "></a>
                        <span className="foot-enter-tt tt-auth"></span>
                    </div>
                    <div className="unit">
                        <a className="foot-enter-new logo-musician" href="//music.163.com/musician/artist"  "></a>
                        <span className="foot-enter-tt tt-musician"></span>
                    </div>
                    <div className="unit">
                        <a className="foot-enter-new logo-reward" href="//music.163.com/web/reward"  "></a>
                        <span className="foot-enter-tt tt-reward"></span>
                    </div>
                    <div className="unit">
                        <a className="foot-enter-new logo-cash" href="//music.163.com/st/ncreator/revenue-plan"  "></a>
