        ...
        <FootWrapper>
            <div className="content w980">
                ...
                <FootRight>
                    <ul>
                        <li className="unit">
                            <a className="foot-enter-new logoamped" href="#"></a>
                            <span className="foot-enter-tt"></span>
                        </li>
                        <li className="unit">
                            <a className="foot-enter-new logoauth" href="#"></a>
                            <span className="foot-enter-tt"></span>
                        </li>
                        <li className="unit">
                            <a className="foot-enter-new logomusician" href="#"></a>
                            <span className="foot-enter-tt"></span>
                        </li>
                        <li className="unit">
                            <a className="foot-enter-new logoreward" href="#"></a>
                            <span className="foot-enter-tt"></span>
                        </li>
                        <li className="unit">
                            <a className="foot-enter-new logocash" href="#"></a>
                            <span className="foot-enter-tt"></span>
                        </li>
                    </ul>
                </FootRight>
