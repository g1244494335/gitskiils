...
const YKAppFooter = memo(() => {
  const showLinks = (item, index) => {
        if (index !== 7) {
            return (
                <Fragment>
                    <a className="item" rel="noopener noreferrer" href={item.link}>{item.title}</a>
    ...
    return (
        <FootWrapper>
            ...
            <p>
              ...
              <a rel="noopener noreferrer" href='https://p5.music.126.net/obj/wo3DlcOGw6DClTvDisK1/8282703158/452a/ca0c/3a10/caad83bc8ffaa850a9dc1613d74824fc.png'>浙网文[2021] 1186-054号</a>
            </p>
            <p>
              <a>粤B2-20090191-18  工业和信息化部备案管理系统网站</a>
              <a className="police-link">
