...
import { getTopBanners, getHotRecommend, getNewAlbums, getTopList, getRankingSongs } from '@/services/recommend'
...
// 显然不是很合理
export const async getNewAlbumgetTopListAction =  () => {
    // console.log(222);
    // let a = await getTopList()
    // console.log(a);
    return async (dispatch) => {
        // console.log(233878322);
        // getTopList().then(res=>dispatch(changeTopListAction(res)))
        console.log(23385788322);
        let a = await getTopList()
        console.log(a);
